...
# Create threat score based on casualties
...
if not country_df.empty:
    ...
    # Recent attacks in country with USER-FRIENDLY column names
    st.markdown("---")
    ...
    if not recent.empty:
        ...
        display_df.columns = ['Year', 'Attack Type', 'Killed', 'Wounded', 'City']  # FIXED: User-friendly names
        st.dataframe(
            display_df,
